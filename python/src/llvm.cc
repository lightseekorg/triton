...
void init_triton_llvm(py::module_ &m) {
  ...
  m.attr("MODULE_FLAG_BEHAVIOR_WARNING") = static_cast<int>(llvm::Module::Warning);
  m.attr("MODULE_FLAG_BEHAVIOR_REQUIRE") = static_cast<int>(llvm::Module::Require);
  m.attr("MODULE_FLAG_BEHAVIOR_OVERRIDE") = static_cast<int>(llvm::Module::Override);
  m.attr("MODULE_FLAG_BEHAVIOR_APPEND") = static_cast<int>(llvm::Module::Append);
  m.attr("MODULE_FLAG_BEHAVIOR_APPEND_UNIQUE") = static_cast<int>(llvm::Module::AppendUnique);
