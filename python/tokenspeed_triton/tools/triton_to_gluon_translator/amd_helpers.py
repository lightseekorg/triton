...
from tokenspeed_triton.experimental.gluon.language.amd.cdna5 import wmma as amd_wmma
from tokenspeed_triton.experimental.gluon.language.amd.cdna5 import tdm as amd_tdm
