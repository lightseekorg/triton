...
This module provides a small command-line wrapper runs the wrapped script with GSan enabled, e.g.
    python -m tokenspeed_triton.tools.gsan my_script.py
"""
...
import torch
from tokenspeed_triton.experimental.gsan._allocator import create_mem_pool
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    tokenspeed_triton.knobs.compilation.instrumentation_mode = "gsan"
