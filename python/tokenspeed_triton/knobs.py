...
from tokenspeed_triton._C.libtriton import getenv, getenv_bool  # type: ignore
...
class cache_knobs(base_knobs):
    ...
    dir = env_str_callable_default("TRITON_CACHE_DIR", lambda: cache.get_triton_dir("tokenspeed-cache"))
...
class proton_knobs(base_knobs):
    ...
    #    tokenspeed_triton.knobs.proton.enable_hw_trace = True
