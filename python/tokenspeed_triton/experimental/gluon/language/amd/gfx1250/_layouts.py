...
from tokenspeed_triton.language.core import _unwrap_if_constexpr
from tokenspeed_triton.runtime.jit import constexpr_function

from tokenspeed_triton.experimental.gluon.language._layouts import PaddedSharedLayout, SharedLayout
...
def make_partitioned_dot_layouts(block_m, block_n, original_layout_a, original_layout_b, num_warps, instr_shape,
    ...
    """
    from tokenspeed_triton.experimental.gluon.language.amd._layouts import AMDWMMALayout
