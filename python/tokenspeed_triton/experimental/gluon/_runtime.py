...
from tokenspeed_triton.compiler.compiler import ASTSource
from tokenspeed_triton.backends.compiler import Language
from tokenspeed_triton.runtime.jit import JITFunction, constexpr_function
...
class GluonASTSource(ASTSource):
    ...
    def make_ir(self, target, options, codegen_fns, module_map, context):
        from tokenspeed_triton.compiler.compiler import make_backend
        from tokenspeed_triton.compiler.code_generator import ast_to_ttir
