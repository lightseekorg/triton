    ...
    def _define_name_lookup(self):
        ...
        def global_lookup(name: str, absent):
            ...
            if any([
                    ...
                    getattr(val, "__module__", "").startswith("tokenspeed_triton.language"),  #
                    getattr(val, "__module__", "").startswith("tokenspeed_triton.experimental.gluon.language"),  #
                    ...
                    #   @tokenspeed_triton.jit def fn(x: tl.constexpr = GLOBAL): ...
            ...
            raise NameError(
                ...
                are instanstiated as constexpr (`x = tokenspeed_triton.language.constexpr(42)`). Note that this is different from
                annotating a variable as constexpr (`x: tokenspeed_triton.language.constexpr = 42`), which is not supported.  Alternatively, set the
