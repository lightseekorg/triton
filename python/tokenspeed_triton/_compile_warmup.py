...
def compile_warmup_only(dispatcher=None):
    ...
    from tokenspeed_triton._compile_warmup_state import _COMPILE_WARMUP_ACTIVE
...
def process_pool_compile_warmup(*, workers, directory, phase):
    from tokenspeed_triton._compile_warmup_pool import ProcessPoolWarmupDispatcher
