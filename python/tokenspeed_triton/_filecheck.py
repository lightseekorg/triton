...
from tokenspeed_triton.compiler import ASTSource, make_backend
...
from tokenspeed_triton.runtime.jit import create_function_from_signature
...
def run_filecheck_test(kernel_fn):
    assert isinstance(kernel_fn, tokenspeed_triton.runtime.JITFunction)
