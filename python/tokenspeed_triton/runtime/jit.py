...
from tokenspeed_triton.backends import BaseBackend
...
from tokenspeed_triton._C.libtriton import get_cache_invalidating_env_vars, native_specialize_impl, ir

TRITON_MODULE = "tokenspeed_triton.language"
GLUON_MODULE = "tokenspeed_triton.experimental.gluon.language"
...
class DependenciesFinder(ast.NodeVisitor):
    ...
    def record_reference(self, val, var_dict=None, name=None):
        ...
        if getattr(val, "__module__", "") == "tokenspeed_triton.language.extra.libdevice":
            return
...
def _normalize_ty(ty) -> str:
    import tokenspeed_triton.language.core as core
...
class JITCallable:
    ...
    def cache_key(self) -> str:
        ...
        with self._hash_lock:
            ...
            from tokenspeed_triton.language.core import constexpr
    ...
    @property
    def type(self):
        from tokenspeed_triton.language.core import constexpr_type
...
class JITFunction(JITCallable, KernelInterface[T]):
    ...
    def __call__(self: "JITFunction[Callable[P, R]]", *args: P.args, **kwargs: P.kwargs) -> R:
        raise RuntimeError("Cannot call @tokenspeed_triton.jit'd outside of the scope of a kernel")
...
class ConstexprFunction(JITCallable, Generic[T]):
    ...
    def __call__(self, *args, _semantic=None, **kwargs):
        from tokenspeed_triton.language.core import _unwrap_if_constexpr, constexpr
